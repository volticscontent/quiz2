...
const bonusItems: PriceItem[] = [
  { id: 1, text: "Badge Edição Limitada NBA Finals", originalValue: "$30", currentValue: "$0", emoji: "🏀" },
  { id: 2, text: "Nome + Número Personalizado", originalValue: "$30", currentValue: "$0", emoji: "" },
  {
    id: 3,
    text: "Autógrafo Oficial do Shai Gilgeous-Alexander",
    originalValue: "$100",
    currentValue: "$0",
    emoji: "✍️",
  },
    ...
    <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-md">
        ...
        <div className="flex items-center space-x-4">
          <div className="w-24 h-24 rounded-lg overflow-hidden bg-gray-50">
            <Image
              ...
              alt="Camisa do Thunder Frente e Verso"
              width={96}
              height={96}
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-1">Thunder Jersey</h3>
            <p className="text-sm text-gray-500">Edição Limitada 2024</p>
          </div>
        </div>
        <div className="text-right">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-1">Preço Original</p>
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex justify-between items-center py-2">
          <span className="text-sm text-gray-600 uppercase tracking-wide">Desconto Conquistado</span>
        ...
        <div className="flex justify-between items-center py-2">
          <span className="text-sm text-gray-900 uppercase tracking-wide font-medium">Preço Final</span>
          <div className="text-right">
            <span className="block text-3xl font-semibold text-gray-900">${finalPrice.toFixed(2)}</span>
            <span className="text-sm text-green-600">Economia de ${discount}</span>
          </div>
        </div>
      </div>
      ...
      {showBonusItems && (
        <div className="space-y-6">
          ...
          <div className="text-center">
            <h3 className="text-lg font-medium text-gray-900 mb-6">Itens Inclusos</h3>
          </div>
